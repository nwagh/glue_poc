...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": s3Outputlocation }, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
## @inputs: [frame = dropnullfields3]
datasink4 = glueContext.write_dynamic_frame.from_options(frame = tranDyF, connection_type = "s3", connection_options = {"path": s3Outputlocation , "partitionKeys": ["Year","Month"] }, format = "parquet", transformation_ctx = "datasink4")
job.commit()